...
-- beautiful.init("/nix/store/22yf17xwnrjyk0m0dvx4pr68gkcawps1-awesome-3.5.6/share/awesome/themes/default/theme.lua")
...
globalkeys = awful.util.table.join(
   ...
   awful.key({ modkey }, "Right", function () awful.client.moveresize( 20,   0,   0,   0) end),
    ...
    awful.key({ modkey,           }, "Super_R", function() awful.util.spawn(lock_cmd) end),
...
awful.rules.rules = {
    ...
    { rule = { name = "Kerbal Space Program" },
...
client.connect_signal("unfocus", function(c)
                         langs[c.pid] = string.sub(awful.util.pread("xkb-switch | head -n1"), 0, -2)
